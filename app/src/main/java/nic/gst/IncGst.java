...
public class IncGst extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_inc_gst, null);
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(gstswitch.isChecked())
                {
                    ...
                    String output = calc.calculate_inclusive(Double.parseDouble(EtAmount.getText().toString()), percentage, true);
                    ...
                    Calculator calc = new Calculator();
                    String output = calc.calculate_inclusive(Double.parseDouble(EtAmount.getText().toString()), percentage, false);
